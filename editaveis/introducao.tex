...
\begin{enumerate}
	...
	\item {\bf Identificar stakeholders:}
...
\begin{figure}[H]
	\centering
	\label{Visão do processo Iniciar Projeto}
		\includegraphics[keepaspectratio=true,scale=0.9,angle=270]{processo/manterPlanejamento.png}
	\caption{Visão do processo Iniciar Projeto.}
\end{figure}
